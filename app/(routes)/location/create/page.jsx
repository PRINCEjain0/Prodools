            ...
            <div key={person.id} className="p-8 border border-black shadow-lg bg-[#F6EFE6]">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(person.id, 'address', e.target.value)}
                  className="w-full px-4 py-2 mt-1 border-b border-gray-300 focus:border-gray-400 focus:ring-0 outline-none"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(person.id, 'latitude', e.target.value)}
                  className="w-full px-4 py-2 mt-1 border-b border-gray-300 focus:border-gray-400 focus:ring-0 outline-none"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange(person.id, 'longitude', e.target.value)}
                  className="w-full px-4 py-2 mt-1 border-b border-gray-300 focus:border-gray-400 focus:ring-0 outline-none"
                />
              </div>

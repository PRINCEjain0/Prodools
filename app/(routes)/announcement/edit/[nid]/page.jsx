...
const AllPersons = () => {
  ...
  const addPerson = () => {
    setPersons([...persons, { id: Date.now(), title: '', firstName: '', middleName: '', lastName: '', details: '', dropboxes: [] }]);
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleChangePerson(personIndex, e)}
                      className="w-full px-4 py-2 mt-1 border-b border-gray-300 focus:border-gray-
400 focus
outline-none"
/>
</div>
...
onChange={(e) => handleChangePerson(personIndex, e)}
className="w-full px-4 py-2 mt-1 border-b border-gray-300 focus
focus
outline-none"
/>
</div>
